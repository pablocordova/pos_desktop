 ...
 * @author pccm
 */
public class JFEstadisticaCliente extends javax.swing.JFrame {

    /**
     * Creates new form JFEstadisticaCliente
     */
    public JFEstadisticaCliente() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ESTADISTICA CLIENTE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFEstadisticaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFEstadisticaCliente().setVisible(true);
            }
        });
    }
